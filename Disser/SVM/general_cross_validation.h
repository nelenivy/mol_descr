...
//class GeneralCrossValidationError : public AbstractObjectiveFunction< VectorSpace<double>, double >
//{
//public:
...
//	CostType* mep_cost;
//	size_t m_folds_num_in_test;
//public:
//
//	GeneralCrossValidationError(
...
//	, mep_trainer(trainer)
//	, mep_cost(cost) 
//	, m_folds_num_in_test(1)
//	{ }
//
//	/// \brief From INameable: return the class name.
//	std::string name() const
//	{
//		return "GeneralCrossValidationError<"
//				+ mep_model->name() + ","
//				+ mep_trainer->name() + ","
//				+ mep_cost->name() + ">";
//	}
...
//	void SetTestFoldsNum(const size_t test_folds_num) {
//		SHARK_ASSERT(test_folds_num < m_folds.size())
//		m_folds_num_in_test = test_folds_num;
//	}

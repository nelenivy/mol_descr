...
void rzeros(int**A,const int n,const int m)
{
 	 A=new int*[m];
 	 for (int i=0;i<m;i++)
 	 {
...
void rzeros(double**A,const int n,const int m)
{
 	 A=new double*[m];
 	 for (int i=0;i<m;i++)
 	 {
...
void rzeros(double*A,const int n)
{
 	 A=new double[n];
 	 for (int j=0;j<n;j++)
 	 	 	 A[j]=0;
...
void rones(int**A,const int n,const int m)
{
 	 A=new int*[m];
 	 for (int i=0;i<m;i++)
 	 {
...
void rones(double**A,const int n,const int m)
{
 	 A=new double*[m];
 	 for (int i=0;i<m;i++)
 	 {
...
void rones(double*A,const int n)
{
 	 A=new double[n];
 	 for (int j=0;j<n;j++)
 	 	 	 A[j]=1;
...
void ones(int**A,const int n,const int m)
{
...
void ones(double**A,const int n,const int m)
{

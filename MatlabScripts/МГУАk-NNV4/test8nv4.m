...
for j=1:MAX
   ...
   max=-1;
    for i1=1:kol_coced
       ...
       % fprintf (fid,'test8v4_k%d_j%d ',i1,j);
       % for i=1:n_molecules
        %    fprintf (fid,' %d ',Class1(i,i1));
        %end
        %fprintf (fid,'\r\n');
        neopr=0;
        Da=0;
...
for i=1:num
    fprintf (fid,'count %f  max %d  neopr %d    k %d    num1 %d    verno %f\r\n',result(1,i),result(2,i),result(3,i),result(4,i),result(5,i),result(2,i)/(n_molecules-result(3,i))*100);
end
fprintf (fid,'\r\n\r\n\r\n');
fclose(fid);
...
for j1=1:glybuna
    ...
    for i=1:num*num
        ...
        fprintf (fid,'verno %f\r\n',result1(2,i)/(n_molecules-result1(3,i))*100);
    end
    fprintf (fid,'\r\n\r\n\r\n');
    fclose(fid);
